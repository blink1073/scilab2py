...
try:
    ...
    from scilab.ipython import scilabmagic
...
class ScilabMagicTest(unittest.TestCase):
    ...
    def test_scilab_cell_magic(self):
        ip = self.ip
        ip.ex('x = 3; y = [1, 2]')
        ip.run_cell_magic('scilab', '-f png -s 400,400 -i x,y -o z',
                          'z = x + y;')
    ...
    def test_scilab_plot(self):
        ...
        self.ip.run_cell_magic('scilab', '-f svg -s 400,500',
    ...
    def test_scilab_syntax_error(self):
        try:
            ...
            self.ip.magic('reload_ext scilab2py.ipython')
